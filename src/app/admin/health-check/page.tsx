        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
              {LINE_NUMS.map((n) => (
                <div key={n} style={{ display: "flex", alignItems: "center", gap: "0.875rem" }}>
                  ...
                  <input
                    type="number" min="0" className="vf-input" inputMode="numeric"
            ...
            <div>
              ...
              <textarea className="vf-input" rows={3} placeholder="Write the reason clearly..."
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
              <button className="vf-btn vf-btn-ghost vf-btn-md" onClick={() => setEditRecord(null)}>Cancel</button>
