    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      <div className="animate-fade-up">
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.25rem" }}>
          <h1 style={{ fontSize: "1.25rem", fontWeight: "800", color: "#fff" }}>Health Check</h1>
          <span style={{
            fontSize: "0.625rem",
            fontWeight: "800",
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <button
                ...
                style={{ background: "var(--nox-surface-2)", border: "1px solid var(--nox-border)", borderRadius: "50%", width: 32, height: 32, cursor: "pointer", color: "var(--nox-text-2)" }}
              >x</button>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
              {LINE_NUMS.map((n) => (
                <div key={n} style={{ display: "flex", alignItems: "center", gap: "0.875rem" }}>
                  ...
                  <input
                    type="number" min="0" className="nox-input" inputMode="numeric"
            ...
            <div>
              ...
              <textarea className="nox-input" rows={3} placeholder="Write the reason clearly..."
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
              <button className="nox-btn nox-btn-ghost nox-btn-md" onClick={() => setEditRecord(null)}>Cancel</button>
