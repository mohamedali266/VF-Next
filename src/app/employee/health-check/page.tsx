  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      ...
      <div className="vf-card animate-fade-up animate-fade-up-delay-1">
        <p style={{ fontSize: "0.8125rem", fontWeight: "600", color: "var(--vf-text-2)", marginBottom: "0.875rem" }}>
          ...
          {(Object.keys(SHIFT_CONFIG) as Shift[]).map((shift) => {
            ...
            return (
              <button
                ...
                style={{
                  border: `2px solid ${isActive ? cfg.color : "var(--vf-border)"}`,
                  background: isActive ? cfg.bg : "var(--vf-surface-2)",
                  borderRadius: "12px",
              ...
              >
                ...
                <span style={{ fontSize: "0.875rem", fontWeight: "800", color: isActive ? cfg.color : "var(--vf-text-2)" }}>
                  {shift}
                </span>
                <span style={{ fontSize: "0.6875rem", color: isActive ? cfg.color : "var(--vf-text-muted)" }}>
                  {cfg.label}
                </span>
              </button>
            );
      ...
      {loading && (
        <div className="vf-card" style={{ textAlign: "center", padding: "2rem" }}>
          ...
          <p style={{ color: "var(--vf-text-muted)", marginTop: "0.75rem", fontSize: "0.875rem" }}>
            جاري التحقق...
          </p>
        </div>
      )}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
            {LINE_LABELS.map((n, idx) => (
              ...
              >
                ...
                <div style={{ flex: 1, fontSize: "0.875rem", color: "var(--vf-text-2)", fontWeight: "600" }}>
                  {n} Line / NID
                </div>
                <input
                  type="number"
          ...
          <div className="vf-card" style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: "2rem", fontWeight: "800", color: "var(--vf-red-light)", lineHeight: 1 }}>
              ...
              <div style={{ textAlign: "center", borderRight: "1px solid var(--vf-border)" }}>
      ...
      {/* Empty State */}
      {!selectedShift && !loading && (
        <div className="vf-card animate-fade-up animate-fade-up-delay-2" style={{
          textAlign: "center", padding: "2.5rem 1rem",
          borderStyle: "dashed", borderColor: "var(--vf-border-light)"
        }}>
          <div style={{ fontSize: "2.5rem", marginBottom: "0.75rem" }}>👆</div>
          <p style={{ color: "var(--vf-text-2)", fontWeight: "600" }}>اختر الشيفت أولاً للبدء</p>
          <p style={{ color: "var(--vf-text-muted)", fontSize: "0.8125rem", marginTop: "0.375rem" }}>
            AM · PM · BW
          </p>
        </div>
      )}
