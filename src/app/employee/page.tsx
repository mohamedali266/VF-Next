  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      <div className="nox-card animate-fade-up" style={{
        ...
        <p style={{ fontSize: "0.75rem", color: "var(--nox-text-muted)", marginBottom: "0.25rem" }}>{today}</p>
        <h2 style={{ fontSize: "1.375rem", fontWeight: "800", color: "#fff", marginBottom: "0.375rem" }}>
          Welcome, {user?.name}
        </h2>
        <p style={{ fontSize: "0.875rem", color: "var(--nox-text-2)" }}>
      ...
      <div>
        <div className="nox-section-header">
          <span className="nox-section-title">Quick Access</span>
